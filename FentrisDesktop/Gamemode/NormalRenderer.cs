...
public class NormalRenderer : GamemodeRenderer
{
    ...
    public override void Draw(GameTime gameTime)
    {
        base.Draw(gameTime);
        SpriteBatch.Begin();
        SpriteBatch.DrawString(DebugFont, Mode.Score.ToString(), new Vector2(0, 300), Color.Aqua);
        SpriteBatch.DrawString(DebugFont, Mode.Combo.ToString(), new Vector2(0, 320), Color.Red);
        SpriteBatch.End();
    }
}